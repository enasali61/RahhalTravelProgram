...
namespace Presistence.Migrations
{
    ...
    [Migration("20260610165138_SubscriptionEntities")]
    partial class SubscriptionEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.OrderEntity.OrderEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.OrderEntity.OrderItem", b =>
                {
                    b.HasOne("Domain.Entities.OrderEntity.OrderEntity", "Order")
                        .WithMany("OrderItems")
